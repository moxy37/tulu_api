...
function LoadSideMenu() {
	var html = '<ul class="menu"><li class="menuItems"><a onclick="goToAbout()">About Us</a></li><li class="menuItems"><p class="menuDropDownTitle" onclick="shopSubMenu()">Shop<i class="fas fa-sort-down shopDropMenuBtn"></i></p><ul class="shopSubMenuList"><li class="subMenuListLink"><a onclick="goToShop()">All</a></li><li class="subMenuListLink"><a onclick="/">New</a></li><li class="subMenuListLink"><a onclick="/">Used</a></li></ul></li><li class="menuItems"><p class="menuDropDownTitle" onclick="accountSubMenu()">My Account<i class="fas fa-sort-down accountDropMenuBtn"></i></p><ul class="accountSubMenuList"><li class="subMenuListLink"><a onclick="goToLogin()">Sign In</a></li><li class="subMenuListLink"><a onclick="goToRegister()">Register</a></li></ul></li><li class="menuItems"><a onclick="goToInfluencer()">Influencers</a></li><li class="menuItems"><a onclick="goToDealership()">Dealerships</a></li><li class="menuItems"><a onclick="Logout()">Logout</a></li><li class="menuItems"><a onclick="/"><button class="influencerBtn">Become an Influencer</button></a></li></ul>';
